...
During a recent pentest I had an issue flagged where the tester could upload a pdf with javascript in it. While this wouldn't really be a problem if opened locally, modern browsers often open them with in-browser viewera which allows the javascript to be executed.
